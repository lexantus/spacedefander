package game.objs
{
	...
	import game.utils.Stage3dObjParser;
	...
	public class Stage3dEntity
	{
		...
		public function Stage3dEntity(mydata:Class = null, mycontext:Context3D = null,
									 ...
									 )
		{
			...
			if(mydata && context)
			{
				mesh = new Stage3dObjParser(mydata, context, modelscale, flipAxis, flipTexture);
		...
		/*	var vectAlpha:Vector.<Number> = new <Number>;
			 	vectAlpha[0] += 0.01;
			
			context.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 0, vectAlpha, -1);*/
